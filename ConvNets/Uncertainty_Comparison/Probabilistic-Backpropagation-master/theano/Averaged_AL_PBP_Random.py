...
for e in range(Experiments):
	...
	np.save('PBP_Random_Acquisition_All_RMSE_' + 'iterations_' + str(acquisition_iterations) + '_Experiment_' + str(e) +'.npy', all_rmse )
...
np.save('Averaged__PBP_Random.npy', Average_RMSE)
