...
print('Using Dropout Probability = 0.005')
...
for e in range(Experiments):
	...
	model = Sequential()
	model.add(Dense(50, input_dim=13, init='normal', activation='relu'))
	...
	# np.save('Dropout_BALD_NewConfigs_Version2_Acquisition_All_RMSE_' + 'iterations_' + str(acquisition_iterations) + '_Experiment_' + str(e) +'.npy', all_rmse )
...
np.save('Averaged__Dropout_BALD_NewConfigs_Version2.npy', Average_RMSE)
