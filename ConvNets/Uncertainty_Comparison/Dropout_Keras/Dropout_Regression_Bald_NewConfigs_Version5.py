...
print('Using Dropout Probability = 0.005 and Linearity = TanH')
...
for e in range(Experiments):
	...
	# np.save('Dropout_BALD_NewConfigs_Version5_Acquisition_All_RMSE_' + 'iterations_' + str(acquisition_iterations) + '_Experiment_' + str(e) +'.npy', all_rmse )
...
np.save('Averaged__Dropout_BALD_NewConfigs_Version5.npy', Average_RMSE)
