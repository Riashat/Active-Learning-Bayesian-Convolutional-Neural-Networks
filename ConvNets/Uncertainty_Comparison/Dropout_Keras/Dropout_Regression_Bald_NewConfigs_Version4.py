...
print('Using Dropout Probability = 0.05, using 3 Hidden Layers instead of 4 and Linearity = TanH')
...
for e in range(Experiments):
	...
	# np.save('Dropout_BALD_NewConfigs_Version4_Acquisition_All_RMSE_' + 'iterations_' + str(acquisition_iterations) + '_Experiment_' + str(e) +'.npy', all_rmse )
...
np.save('Averaged__Dropout_BALD_NewConfigs_Version4.npy', Average_RMSE)
