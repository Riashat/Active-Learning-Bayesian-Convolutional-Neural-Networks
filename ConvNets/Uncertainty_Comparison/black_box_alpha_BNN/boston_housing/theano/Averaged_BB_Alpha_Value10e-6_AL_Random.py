...
for e in range(Experiments):
    ...
    np.save('BB_Alpha_Random_Acquisition_Value10e-6_All_RMSE_' + 'iterations_' + str(acquisition_iterations) + '_Experiment_' + str(e) +'.npy', all_rmse )
...
np.save('Averaged_BB_Alpha_Value10e-6_Random.npy', Average_RMSE)
