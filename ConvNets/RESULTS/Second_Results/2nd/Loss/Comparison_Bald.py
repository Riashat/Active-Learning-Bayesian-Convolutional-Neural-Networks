...
plt.plot(epochs, Bald_Train_Loss[:,20],color="red", linewidth=1.0, marker='+',label="20th - Training")
...
plt.plot(epochs, Bald_Valid_Loss[:,20],color="black", linewidth=1.0, marker='+',label="20th - Validation")
