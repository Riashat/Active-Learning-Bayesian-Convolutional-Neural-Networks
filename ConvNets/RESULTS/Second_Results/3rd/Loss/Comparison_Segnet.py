...
plt.plot(epochs, Bayes_Segnet_Train_Loss[:,15],color="red", linewidth=1.0, marker='+',label="15th - Training")
...
plt.plot(epochs, Bayes_Segnet_Valid_Loss[:,15],color="black", linewidth=1.0, marker='+',label="15th - Validation")
