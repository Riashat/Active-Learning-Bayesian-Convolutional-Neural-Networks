...
plt.plot(epochs, Dropout_Max_Entropy_Train[:,20],color="red", linewidth=1.0, marker='+',label="20th - Training")
...
plt.plot(epochs, Dropout_Max_Entropy_Valid[:,20],color="black", linewidth=1.0, marker='+',label="20th - Validation")
