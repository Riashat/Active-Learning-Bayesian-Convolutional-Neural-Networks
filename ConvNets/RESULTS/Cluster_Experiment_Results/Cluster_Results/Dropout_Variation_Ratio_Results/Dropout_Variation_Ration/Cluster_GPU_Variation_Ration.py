...
for e in range(Experiments):
	...
	X_valid = X_train_All[4000:4500, :, :, :]
	y_valid = y_train_All[4000:4500]
	...
	np.save(''+'3rd_Run_All_Train_Loss_'+ 'Experiment_' + str(e) + '.npy', Pool_Train_Loss)
	np.save(''+ '3rd_Run_All_Valid_Loss_'+ 'Experiment_' + str(e) + '.npy', Pool_Valid_Loss)
	np.save(''+'3rd_Run_All_Pooled_Image_Index_'+ 'Experiment_' + str(e) + '.npy', x_pool_All)
	np.save(''+ '3rd_Run_All_Accuracy_Results_'+ 'Experiment_' + str(e) + '.npy', all_accuracy)

print('Saving Average Accuracy Over Experiments')

Average_Accuracy = np.divide(Experiments_All_Accuracy, Experiments)

np.save(''+'3rd_RunAverage_Accuracy'+'.npy', Average_Accuracy)
