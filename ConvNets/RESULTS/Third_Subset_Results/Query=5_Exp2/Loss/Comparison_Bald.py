...
plt.plot(epochs, Bald_Train_Loss[:,16],color="red", linewidth=1.0, marker='+',label="16th - Training")
...
plt.plot(epochs, Bald_Valid_Loss[:,16],color="black", linewidth=1.0, marker='+',label="16th - Validation")
