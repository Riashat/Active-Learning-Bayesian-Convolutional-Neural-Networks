...
for e in range(Experiments):
	...
	for i in range(acquisition_iterations):
		...
		for d in range(dropout_iterations):
			...
			dropout_classes = model.predict_classes_stochastic(X_Pool,batch_size=batch_size, verbose=0)
	...
	np.save(''+'1st_Train_Loss_'+ 'Experiment_' + str(e) + '.npy', Pool_Train_Loss)
	np.save(''+ '1st_Valid_Loss_'+ 'Experiment_' + str(e) + '.npy', Pool_Valid_Loss)
	np.save(''+'1st_Train_Loss_'+ 'Experiment_' + str(e) + '.npy', Pool_Train_Acc)
	np.save(''+ '1st_Valid_Loss_'+ 'Experiment_' + str(e) + '.npy', Pool_Valid_Acc)
	np.save(''+'1st_Pooled_Image_Index_'+ 'Experiment_' + str(e) + '.npy', x_pool_All)
	np.save(''+ '1st_Accuracy_Results_'+ 'Experiment_' + str(e) + '.npy', all_accuracy)

print('Saving Average Accuracy Over Experiments')

Average_Accuracy = np.divide(Experiments_All_Accuracy, Experiments)

np.save(''+'1st_Average_Accuracy'+'.npy', Average_Accuracy)
