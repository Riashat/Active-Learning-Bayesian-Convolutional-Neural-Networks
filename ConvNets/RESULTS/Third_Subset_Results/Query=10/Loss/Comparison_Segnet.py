...
plt.plot(epochs, Bayes_Segnet_Train_Loss[:,50],color="red", linewidth=1.0, marker='x',label="50th - Training")
plt.plot(epochs, Bayes_Segnet_Train_Loss[:,90],color="red", linewidth=1.0, marker='+',label="90th - Training")

plt.plot(epochs, Bayes_Segnet_Valid_Loss[:,1], color="black", linewidth=1.0, marker='o',label="1st - Validation")
plt.plot(epochs, Bayes_Segnet_Valid_Loss[:,50],color="black", linewidth=1.0, marker='x',label="50th - Validation")
plt.plot(epochs, Bayes_Segnet_Valid_Loss[:,90],color="black", linewidth=1.0, marker='+',label="90th - Validation")
