...
X_Pool = X_train_All[1001:49000, 0:3, 0:32, 0:32]
...
score = model.predict_proba(X_Pool,batch_size=batch_size, verbose=1)		#score is a numpy array

scipy.io.savemat('Score1.mat', dict(score1 = score))
