...
X_train = X_train_All[0:11000, 0:3,0:32,0:32]
y_train = y_train_All[0:11000, :]
...
X_Pool = X_train_All[11000:50000, 0:3, 0:32, 0:32]
Y_Oracle = y_train_All[11000:50000, :]
...
#number of points to query at a time
N = 1000
...
for i in range(acquisition_iterations):
	...
	R = np.asarray(random.sample(range(11000,50000), N))	
