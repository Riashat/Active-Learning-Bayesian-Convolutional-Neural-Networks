...
Dropout_Queries = np.arange(100, 510, 10)
...
pl.subplot(2, 2, 1) 
plt.plot(Dropout_Queries, Dropout_Bald[0:41], color="red", linewidth=1.0, marker='x', label=r"\textbf{Dropout BALD}" )
...
pl.subplot(2, 2, 2)
plt.plot(Dropout_Queries, Dropout_Max_Entropy[0:41], color="red", linewidth=1.0, marker='x', label=r"\textbf{Dropout Max Entropy}" )
...
pl.subplot(2, 2, 3)
plt.plot(Dropout_Queries, Dropout_VarRatio[0:41], color="red", linewidth=1.0, marker='x', label=r"\textbf{Dropout Variation Ratio}" )
...
pl.subplot(2, 2, 4)
plt.plot(Dropout_Queries, Dropout_Segnet[0:41], color="red", linewidth=1.0, marker='x', label=r"\textbf{Dropout Bayes Segnet}" )
