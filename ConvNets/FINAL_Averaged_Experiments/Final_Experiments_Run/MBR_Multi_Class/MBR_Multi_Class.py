...
for e in range(Experiments):
	...
	Experiments_All_Accuracy = Experiments_All_Accuracy + all_accuracy
 	...
 	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/New_Final_Experiments/Results/'+'Multi_Class_MBR_Q10_N1000_Train_Acc_'+ 'Experiment_' + str(e) + '.npy', Pool_Train_Acc)
