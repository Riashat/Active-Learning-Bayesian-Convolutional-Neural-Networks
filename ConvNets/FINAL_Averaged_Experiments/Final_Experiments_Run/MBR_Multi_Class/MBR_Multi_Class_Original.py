...
for e in range(Experiments):
	...
	X_Pool_All = X_train_All[30000:40000, :, :, :]
	y_Pool_All = y_train_All[30000:40000]
	...
	X_Pool_All = X_Pool_All.astype('float32')
	X_train /= 255
	X_valid /= 255
	X_Pool_All /= 255
	X_test /= 255
	...
	Y_Pool = np_utils.to_categorical(y_Pool_All, nb_classes)
	...
	for i in range(acquisition_iterations):
		...
		#subsample from the pool set
		pool_subsample = 100
		pool_subset_subsample = np.asarray(random.sample(range(0,X_Pool_All.shape[0]), pool_subsample))
		X_Pool = X_Pool_All[pool_subset_subsample, :, :, :]
		y_Pool = y_Pool_All[pool_subset_subsample]
		...
		for k in range(pool_subsample):
			...
			#only changing this for version 2
		...
		X_Pool_All = np.delete(X_Pool_All, x_pool_index, 0)
		...
		print('All Accuracy So Far:', all_accuracy)
	...
	Experiments_All_Accuracy = Experiments_All_Accuracy + all_accuracy
 	...
 	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/New_Final_Experiments/Results/'+'Multi_Class_MBR_Original_Q10_N1000_Train_Loss_'+ 'Experiment_' + str(e) + '.npy', Pool_Train_Loss)
 	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/New_Final_Experiments/Results/'+ 'Multi_Class_MBR_Original_Q10_N1000_Valid_Loss_'+ 'Experiment_' + str(e) + '.npy', Pool_Valid_Loss)
 	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/New_Final_Experiments/Results/'+'Multi_Class_MBR_Original_Q10_N1000_Train_Acc_'+ 'Experiment_' + str(e) + '.npy', Pool_Train_Acc)
 	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/New_Final_Experiments/Results/'+ 'Multi_Class_MBR_Original_Q10_N1000_Valid_Acc_'+ 'Experiment_' + str(e) + '.npy', Pool_Valid_Acc)
 	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/New_Final_Experiments/Results/'+ 'Multi_Class_MBR_Original_Q10_N1000_Accuracy_Results_'+ 'Experiment_' + str(e) + '.npy', all_accuracy)

print('Saving Average Accuracy Over Experiments')

Average_Accuracy = np.divide(Experiments_All_Accuracy, Experiments)

np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/New_Final_Experiments/Results/'+'Multi_Class_MBR_Original_Q10_N1000_Average_Accuracy'+'.npy', Average_Accuracy)
