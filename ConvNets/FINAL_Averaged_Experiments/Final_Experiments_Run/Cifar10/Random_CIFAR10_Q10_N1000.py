...
for e in range(Experiments):
	...
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/New_Final_Experiments/Results/'+'Cifar10_Random_Q10_N1000_All_Train_Loss_'+ 'Experiment_' + str(e) + '.npy', Pool_Train_Loss)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/New_Final_Experiments/Results/'+ 'Cifar10_Random_Q10_N1000_All_Valid_Loss_'+ 'Experiment_' + str(e) + '.npy', Pool_Valid_Loss)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/New_Final_Experiments/Results/'+'Cifar10_Random_Q10_N1000_All_Pooled_Image_Index_'+ 'Experiment_' + str(e) + '.npy', x_pool_All)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/New_Final_Experiments/Results/'+ 'Cifar10_Random_Q10_N1000_All_Accuracy_Results_'+ 'Experiment_' + str(e) + '.npy', accuracy)

print('Saving Average Accuracy Over Experiments')

Average_Accuracy = np.divide(Experiments_All_Accuracy, Experiments)

np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/New_Final_Experiments/Results/'+'Cifar10_Random_Q10_N1000_Average_Accuracy'+'.npy', Average_Accuracy)
