...
for e in range(Experiments):
	...
	model = Sequential()
	model.add(Dense(50, W_regularizer=l2(Weight_Decay), input_dim=13, init='normal', activation='relu'))
	...
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/New_Final_Experiments/Results/'+'Regression_Dropout_BALD_YarinConfigs_Acquisition_All_RMSE_' + 'iterations_' + str(acquisition_iterations) + '_Experiment_' + str(e) +'.npy', all_rmse )
...
np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/New_Final_Experiments/Results/'+ 'Regression_Dropout_BALD_YarinConfigs.npy', Average_RMSE)
