...
for e in range(Experiments):
	...
	model.add(Flatten())
	model.add(Dense(1000, W_regularizer=l2(Weight_Decay)))
	model.add(Activation('relu'))
	...
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Uncertainty_Calibrations/Hidden_Units/Results/'+'Hidden_Units_1000_Bald_Q10_N1000_Train_Loss_'+ 'Experiment_' + str(e) + '.npy', Pool_Train_Loss)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Uncertainty_Calibrations/Hidden_Units/Results/'+ 'Hidden_Units_1000_Bald_Q10_N1000_Valid_Loss_'+ 'Experiment_' + str(e) + '.npy', Pool_Valid_Loss)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Uncertainty_Calibrations/Hidden_Units/Results/'+'Hidden_Units_1000_Bald_Q10_N1000_Train_Acc_'+ 'Experiment_' + str(e) + '.npy', Pool_Train_Acc)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Uncertainty_Calibrations/Hidden_Units/Results/'+ 'Hidden_Units_1000_Bald_Q10_N1000_Valid_Acc_'+ 'Experiment_' + str(e) + '.npy', Pool_Valid_Acc)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Uncertainty_Calibrations/Hidden_Units/Results/'+'Hidden_Units_1000_Bald_Q10_N1000_Pooled_Image_Index_'+ 'Experiment_' + str(e) + '.npy', x_pool_All)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Uncertainty_Calibrations/Hidden_Units/Results/'+ 'Hidden_Units_1000_Bald_Q10_N1000_Accuracy_Results_'+ 'Experiment_' + str(e) + '.npy', all_accuracy)

print('Saving Average Accuracy Over Experiments')

Average_Accuracy = np.divide(Experiments_All_Accuracy, Experiments)

np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Uncertainty_Calibrations/Hidden_Units/Results/'+'Hidden_Units_1000_Bald_Q10_N1000_Average_Accuracy'+'.npy', Average_Accuracy)
