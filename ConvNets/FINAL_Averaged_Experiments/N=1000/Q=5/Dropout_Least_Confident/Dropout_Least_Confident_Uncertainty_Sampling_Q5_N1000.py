...
for e in range(Experiments):
	...
	for i in range(acquisition_iterations):
		...
		#take random subset of pool points
		pool_subset = 2000
		...
		Avg_Predicted_Probabiliteis = np.divide(score_All, dropout_iterations)

		Least_Confident = 0
		# compute least confidency for each pool point
		for d in range(Avg_Predicted_Probabiliteis.shape[0]):
			D = Avg_Predicted_Probabiliteis[d, :]
	...
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Least_Confident/Results/'+'Averaged_Main_Dropout_Least_Confident_Q5_N1000_Train_Loss_'+ 'Experiment_' + str(e) + '.npy', Pool_Train_Loss)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Least_Confident/Results/'+ 'Averaged_Main_Dropout_Least_Confident_Q5_N1000_Valid_Loss_'+ 'Experiment_' + str(e) + '.npy', Pool_Valid_Loss)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Least_Confident/Results/'+'Averaged_Main_Dropout_Least_Confident_Q5_N1000_Train_Acc_'+ 'Experiment_' + str(e) + '.npy', Pool_Train_Acc)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Least_Confident/Results/'+ 'Averaged_Main_Dropout_Least_Confident_Q5_N1000_Valid_Acc_'+ 'Experiment_' + str(e) + '.npy', Pool_Valid_Acc)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Least_Confident/Results/'+'Averaged_Main_Dropout_Least_Confident_Q5_N1000_Pooled_Image_Index_'+ 'Experiment_' + str(e) + '.npy', x_pool_All)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Least_Confident/Results/'+ 'Averaged_Main_Dropout_Least_Confident_Q5_N1000_Accuracy_Results_'+ 'Experiment_' + str(e) + '.npy', all_accuracy)

print('Saving Average Accuracy Over Experiments')

Average_Accuracy = np.divide(Experiments_All_Accuracy, Experiments)

np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Least_Confident/Results/'+'Averaged_Main_Dropout_Least_Confident_Q5_N1000_Average_Accuracy'+'.npy', Average_Accuracy)
