...
for e in range(Experiments):
	...
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Minimum_Expected_Entropy/Results/'+ 'Averaged_Main_MEE_Q10_N1000_rmse_Results_'+ 'Experiment_' + str(e) + '.npy', all_rmse)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Minimum_Expected_Entropy/Results/'+ 'Averaged_Main_MEE_Q10_N1000_logLikelihood_Results_'+ 'Experiment_' + str(e) + '.npy', all_predicted_log_likelihood)
