...
for e in range(Experiments):
	...
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Uncertainty_Calibrations/Softmax_Bald/Results/'+'Averaged_Main_Bald_Q10_N1000_Train_Loss_'+ 'Experiment_' + str(e) + '.npy', Pool_Train_Loss)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Uncertainty_Calibrations/Softmax_Bald/Results/'+ 'Averaged_Main_Bald_Q10_N1000_Valid_Loss_'+ 'Experiment_' + str(e) + '.npy', Pool_Valid_Loss)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Uncertainty_Calibrations/Softmax_Bald/Results/'+'Averaged_Main_Bald_Q10_N1000_Train_Acc_'+ 'Experiment_' + str(e) + '.npy', Pool_Train_Acc)
...
np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Uncertainty_Calibrations/Softmax_Bald/Results/'+'Averaged_Main_Bald_Q10_N1000_Average_Accuracy'+'.npy', Average_Accuracy)
