...
for e in range(Experiments):
	...
	for i in range(acquisition_iterations):
		...
		for d in range(softmax_iterations):
			print('Softmax Uncertainty Estimate Iterations', d)
			hist = model.fit(X_train, Y_train, batch_size=batch_size, nb_epoch=nb_epoch, show_accuracy=True, verbose=0)
			softmax_classes = model.predict_classes(X_Pool_Dropout,batch_size=batch_size, verbose=0)
			softmax_classes = np.array([softmax_classes]).T
			All_Dropout_Classes = np.append(All_Dropout_Classes, softmax_classes, axis=1)
		...
		for t in range(X_Pool_Dropout.shape[0]):
			L = np.array([0])
			for d_iter in range(softmax_iterations):
				L = np.append(L, All_Dropout_Classes[t, d_iter+1])						
			Predicted_Class, Mode = mode(L[1:])
			v = np.array(  [1 - Mode/float(softmax_iterations)])
			Variation[t] = v
	...
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Uncertainty_Calibrations/Softmax_Variation_Ratio/Results/'+'Averaged_Main_VarRatio_Q10_N1000_Train_Loss_'+ 'Experiment_' + str(e) + '.npy', Pool_Train_Loss)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Uncertainty_Calibrations/Softmax_Variation_Ratio/Results/'+ 'Averaged_Main_VarRatio_Q10_N1000_Valid_Loss_'+ 'Experiment_' + str(e) + '.npy', Pool_Valid_Loss)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Uncertainty_Calibrations/Softmax_Variation_Ratio/Results/'+'Averaged_Main_VarRatio_Q10_N1000_Train_Acc_'+ 'Experiment_' + str(e) + '.npy', Pool_Train_Acc)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Uncertainty_Calibrations/Softmax_Variation_Ratio/Results/'+ 'Averaged_Main_VarRatio_Q10_N1000_Valid_Acc_'+ 'Experiment_' + str(e) + '.npy', Pool_Valid_Acc)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Uncertainty_Calibrations/Softmax_Variation_Ratio/Results/'+'Averaged_Main_VarRatio_Q10_N1000_Pooled_Image_Index_'+ 'Experiment_' + str(e) + '.npy', x_pool_All)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Uncertainty_Calibrations/Softmax_Variation_Ratio/Results/'+ 'Averaged_Main_VarRatio_Q10_N1000_Accuracy_Results_'+ 'Experiment_' + str(e) + '.npy', all_accuracy)

print('Saving Average Accuracy Over Experiments')

Average_Accuracy = np.divide(Experiments_All_Accuracy, Experiments)

np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Uncertainty_Calibrations/Softmax_Variation_Ratio/Results/'+'Averaged_Main_VarRatio_Q10_N1000_Average_Accuracy'+'.npy', Average_Accuracy)
