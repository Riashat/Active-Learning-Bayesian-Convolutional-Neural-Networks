...
for e in range(Experiments):
	...
	np.save('/home/ri258/Documents/Project/Active-Learning-Deep-Convolutional-Neural-Networks/ConvNets/Cluster_Experiments/Dropout_Bayes_Segnet/Results/'+'Train_Loss_'+ 'Experiment_' + str(e) + '.npy', Pool_Train_Loss)
