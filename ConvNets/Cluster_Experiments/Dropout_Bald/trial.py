...
for e in range(Experiments):
	...
	# np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Bald/Results/'+'Subset_2nd_Train_Loss_'+ 'Experiment_' + str(e) + '.npy', Pool_Train_Loss)
	# np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Bald/Results/'+ 'Subset_2nd_Valid_Loss_'+ 'Experiment_' + str(e) + '.npy', Pool_Valid_Loss)
	# np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Bald/Results/'+'Subset_2nd_Train_Acc_'+ 'Experiment_' + str(e) + '.npy', Pool_Train_Acc)
	# np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Bald/Results/'+ 'Subset_2nd_Valid_Acc_'+ 'Experiment_' + str(e) + '.npy', Pool_Valid_Acc)
	# np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Bald/Results/'+'Subset_2nd_Pooled_Image_Index_'+ 'Experiment_' + str(e) + '.npy', x_pool_All)
	# np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Bald/Results/'+ 'Subset_2nd_Accuracy_Results_'+ 'Experiment_' + str(e) + '.npy', all_accuracy)
	...
	np.save('Subset_2nd_Train_Acc_'+ 'Experiment_' + str(e) + '.npy', Pool_Train_Acc)
	np.save('Subset_2nd_Valid_Acc_'+ 'Experiment_' + str(e) + '.npy', Pool_Valid_Acc)
...
# np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Bald/Results/'+'Subset_2nd_Average_Accuracy'+'.npy', Average_Accuracy)
