...
for e in range(Experiments):
	...
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Bald/Results/'+'Main_Part2_Train_Acc_'+ 'Experiment_' + str(e) + '.npy', Pool_Train_Acc)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Bald/Results/'+ 'Main_Part2_Valid_Acc_'+ 'Experiment_' + str(e) + '.npy', Pool_Valid_Acc)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Bald/Results/'+'Main_Part2_Pooled_Image_Index_'+ 'Experiment_' + str(e) + '.npy', x_pool_All)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Bald/Results/'+ 'Main_Part2_Accuracy_Results_'+ 'Experiment_' + str(e) + '.npy', all_accuracy)

print('Saving Average Accuracy Over Experiments')

Average_Accuracy = np.divide(Experiments_All_Accuracy, Experiments)

np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Bald/Results/'+'Main_Part2_Average_Accuracy'+'.npy', Average_Accuracy)
...
array([[ 5.],
 ...
 b = np.power(a, 3)		# cubic



 In [31]: x
Out[31]: array([5, 1, 5, 7, 8, 9])

In [32]: y = np.flipud(x)

In [33]: y
Out[33]: array([9, 8, 7, 5, 1, 5])


In [35]: x
Out[35]: array([5, 1, 5, 7, 8, 9])

In [36]: z = np.concatenate((y,x), axis=0)

In [37]: z
Out[37]: array([9, 8, 7, 5, 1, 5, 5, 1, 5, 7, 8, 9])

In [38]: z = np.concatenate((x,y), axis=0)

In [39]: z
Out[39]: array([5, 1, 5, 7, 8, 9, 9, 8, 7, 5, 1, 5])
...
In [122]: X4 = np.array([[3,4,5], [5,6,7]])
...
In [125]: Y4 = np.multiply(X4, gamma)
