...
for e in range(Experiments):
	...
	# X_valid = X_train_All[10000:10500, :, :, :]
	# y_valid = y_train_All[10000:10500]
	...
	for i in range(acquisition_iterations):
		...
		sample_weight = np.append(sample_weight_constant, gamma)
	...
	print('All Accuracy Values', all_accuracy)
