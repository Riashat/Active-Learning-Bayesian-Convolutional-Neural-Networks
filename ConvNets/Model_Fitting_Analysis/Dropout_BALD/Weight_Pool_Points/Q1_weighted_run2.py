...
gamma = np.zeros(shape=(Queries))
gamma_value = 0.9
starting_gamma_value = 1
...
for e in range(Experiments):
	...
	gamma.fill(starting_gamma_value)
	...
	for i in range(acquisition_iterations):
		...
		#at every iteration, concatenate the gamma vector and multiply with queried points
		...
		print('Separating Queried Points for Weighting')
		Queried_Points = X_train[Original_Training_Size:, :, :, :]


		print('Multiply by Gamma Weightings')
		Queried_Points = (Queried_Points.T * gamma).T

		print('Add weighted queried points back to Original Inputs')
		X_train = X_train[0:Original_Training_Size, :, :, :]	
		
		X_train = np.concatenate((X_train, Queried_Points), axis=0)	
	...
	#np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Bald/Results/'+'Main_Train_Loss_'+ 'Experiment_' + str(e) + '.npy', Pool_Train_Loss)
	#np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Bald/Results/'+ 'Main_Valid_Loss_'+ 'Experiment_' + str(e) + '.npy', Pool_Valid_Loss)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Bald/Results/'+'Q1_Weighted_Run2_Train_Acc_'+ 'Experiment_' + str(e) + '.npy', Pool_Train_Acc)
	np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Bald/Results/'+ 'Q1_Weighted_Run2_Valid_Acc_'+ 'Experiment_' + str(e) + '.npy', Pool_Valid_Acc)
	# np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Bald/Results/'+'Weighted_Pooled_Run2_Image_Index_'+ 'Experiment_' + str(e) + '.npy', x_pool_All)
	# np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Bald/Results/'+ 'Weighted_Run2_Accuracy_Results_'+ 'Experiment_' + str(e) + '.npy', all_accuracy)

print('Saving Average Accuracy Over Experiments')

Average_Accuracy = np.divide(Experiments_All_Accuracy, Experiments)

np.save('/home/ri258/Documents/Project/MPhil_Thesis_Cluster_Experiments/ConvNets/Cluster_Experiments/Dropout_Bald/Results/'+'Q1_Weighted_Run2_Average_Accuracy'+'.npy', Average_Accuracy)
