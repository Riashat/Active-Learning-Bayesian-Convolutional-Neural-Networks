...
for e in range(Experiments):
	...
	for i in range(acquisition_iterations):
		...
		# We make predictions on the pool set
		m_pool, v_pool = net.predict(X_pool)
	...
	np.save('AEPDGP_BALD_Acquisition_All_RMSE_' + 'iterations_' + str(acquisition_iterations) + '_Experiment_' + str(e) +'.npy', all_rmse )
...
np.save('Averaged__AEPDGP_BALD.npy', Average_RMSE)
